...
//
//		//return to http
//		fmt.Fprintf(w, "URL: %s, Response took: %s Code: %s, Hostname: %s,\nBody: %s", url, endRes.Sub(startRes), strconv.Itoa(resp.StatusCode), hostname, bodyString)
//
//	} else {
//		//fmt.Println("stdout errors:", errs)
//		w.WriteHeader(401)
//		//prints to http client
//		fmt.Fprintf(w, "Status code from %s: %s, hostname:", url, strconv.Itoa(resp.StatusCode), hostname )
//	}
//}
